...
export class OrderPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.orderTrackingString = page.locator(
      '[data-name="orderSuccessfullyCreated-popup"] span.notification-popup__text',
    )
    this.SuccessfullyCreatedOrderButton = new Button(
      page,
